                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('managesubject.update', $subject->id)}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="id" type="text" class="form-control{{ $errors->has('id') ? ' is-invalid' : '' }}" name="id" value="{{ $subject->id }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sub_name" type="text" class="form-control{{ $errors->has('sub_name') ? ' is-invalid' : '' }}" name="sub_name" value="{{ $subject->sub_name }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="sub_description" id="editor">{!! $subject->sub_description !!}</textarea>
                            </div>
                        </div>
